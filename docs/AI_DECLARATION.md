...
| **Relatórios executivos** | Geração de sumários executivos em português e inglês para cada etapa da auditoria, com identificação de riscos, falhas e recomendações priorizadas | `reports/`, `03_RELATORIO_BSB2026/` |
